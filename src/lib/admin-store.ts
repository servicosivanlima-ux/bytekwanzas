...
export const DEFAULT_PORTFOLIO: PortfolioItem[] = [
  ...
  },
  {
    id: "aderitosilva",
    name: "ADÉRITO SILVA",
    url: "https://aderitosilva.online/",
    display: "https://aderitosilva.online/",
    screenshot: "/aderitosilva-preview.png",
    desc: "COMÉRCIO GERAL • PRESTAÇÃO DE SERVIÇOS — Cinco áreas de negócio, uma só equipa de confiança.",
    tags: ["Prestação", "Serviços", "Sacos", "Personalizados", "Construção", "Gráfica", "Manutenção", "Geradores", "Angola"],
    accent: "oklch(0.72_0.13_78)",
  },
  {
    id: "quickniss",
    name: "QUICK NISS",
    url: "https://quickniss.store/",
    display: "https://quickniss.store/",
    screenshot: "/quickniss-preview.png",
    desc: "Trate o pedido de NISS em Portugal com acompanhamento completo: envio seguro de documentos, validação por especialistas e estado do processo em tempo real.",
    tags: ["Prestação de Serviços", "Portal Web", "Angola", "Portugal"],
    accent: "oklch(0.55_0.15_220)",
  },
  {
    id: "kwanzashop",
